...
-   **Restrooms**. Directly outside the classroom.
...
-   **Name tags**. Please wear during workshop to make connecting with others easier! Please return after the Workshop to help us be greener.
-   Contact Meaghan Doherty **914-522-8114** for assistance
...
# Workshop 2024 (needs to update with photo from last year)
...
-   **Wi-Fi** Network: guest-net (no password). Open any webpage (i.e. BBC News, Amazon, etc.) on your browser, a pop-up will appear to connect to guest Wi-Fi. Accept terms to gain access.
-   **Restrooms**. Directly outside the classroom (women on the left, men on the right)
-   **Course materials**. All Material (lectures/labs) is located on Posit Cloud. You were invited to the ‘sharp_bayesian_environmental_health_2023’ Workspace via email on Sunday 8/12.
-   **Name tags**. Please wear during workshop to make connecting with others easier! Please return after the Workshop to help us be greener.
-   Contact Meaghan Doherty **914-522-8114** for assistance
