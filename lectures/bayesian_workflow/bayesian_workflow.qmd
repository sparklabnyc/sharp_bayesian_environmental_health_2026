...
-   Alongside "exact"methods such as MCMC, there also exist approximate methods, such as Variation Inference (VI) and integrated nested Laplace approximation.
...
Better: now the range of prior predictive draws is covering the data. \## Diagnosing MCMC outputs
...
-   Information criteria. Penalise complexity over the fit. The smaller the better. Examples: DIC, WAIC, AIC, BIC, etc.
